...
class Ui_IvyQUIC(object):
    def setupUi(self, IvyQUIC):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 254, 610))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 253, 610))
    ...
    def retranslateUi(self, IvyQUIC):
        ...
        IvyQUIC.setWindowTitle(_translate("IvyQUIC", "Ivy QUIC GUI"))
