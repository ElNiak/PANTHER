# a_rfc — reconstructed specifications

`a_rfc` reconstructs an RFC-style specification from a software project's own
history, and gates every claim against the evidence behind it. It lives at
`panther/plugins/services/testers/a_rfc/`.
...
The package README at `panther/plugins/services/testers/a_rfc/README.md` carries
