...
class StepConfig:
    ...
    Attributes:
        ...
        record_pcap (Optional[bool]): An optional flag indicating whether to record PCAP (Packet Capture). Defaults to None.
    """
...
class TestConfig:
    ...
    Attributes:
        ...
        steps (Optional[StepConfig]): Configuration for the steps of the test. Defaults to None.
        assertions (Optional[List[AssertionConfig]]): List of assertions for the test. Defaults to None.
        fast_fail_enabled (Optional[bool]): Whether to enable fast-fail for this specific test.
            Only used when global fast_fail.test_level is True. If None, uses global setting.
    """
    ...
    fast_fail_enabled: Optional[bool] = None  # Test-level fast-fail override
