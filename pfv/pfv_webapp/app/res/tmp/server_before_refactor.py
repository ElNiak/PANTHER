...
class IvyServer:
    ...
    def __init__(self,dir_path=None,experiments=None):
        ...
        IvyServer.ivy_model_path = dir_path + "/pfv-ivy/doc/examples/quic"
        IvyServer.ivy_test_path = dir_path  + "/pfv-ivy/doc/examples/quic/quic_tests/"
        IvyServer.ivy_temps_path = dir_path + "/pfv-ivy/doc/examples/quic/test/temp/"
        IvyServer.ivy_include_path = dir_path + "/pfv-ivy/ivy/include/1.7/"
        IvyServer.local_path = os.environ["ROOT_PATH"] + "/pfv-ivy/doc/examples/quic/test/temp/"
                ...
                for line in input_file_content_lines:
                    ...
                    if "implementation of" in line:
                        ...
                        if "server_test" in splitted_line[0]:
                            prefix =  "/app/pfv-ivy/doc/examples/quic/quic_tests/server_tests/"
                        elif "client_test" in splitted_line[0]:
                            prefix =  "/app/pfv-ivy/doc/examples/quic/quic_tests/client_tests/"
    ...
    def serve_attack():
        ...
        def call_python_version(Version, Module, Function, ArgumentList):
            folder = PFV.SOURCE_DIR + "/pfv-ivy/doc/examples/quic/quic_tests/server_tests/"
            IvyServer.experiments.update_includes_ptls()
            IvyServer.experiments.update_includes()
