...
from pfv_runner.pfv_apt_runner import APTRunner
    ...
    def update_ivy_tool(self):
        ...
        for file in files:
            ...
            execute_command(
                "sudo /bin/cp -f -a "
                + SOURCE_DIR
                + "/app/pfv-ivy/lib/*.a /usr/local/lib/python2.7/dist-packages/ms_ivy-1.8.24-py2.7.egg/ivy/lib"
            )
