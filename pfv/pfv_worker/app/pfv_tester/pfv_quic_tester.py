    ...
    def __init__(
        ...
        self.specials2 = {
            ...
            "quic_server_test_retry": {
                ...
                + SOURCE_DIR
                + "/pfv-ivy/doc/examples/quic/cert.pem --early-data --dump-packets "
                + SOURCE_DIR
                + "/qlogs/quiche/dump_packet.txt --key "
                + SOURCE_DIR
                + "/pfv-ivy/doc/examples/quic/priv.key --listen 127.0.0.1:4443",
                "quinn": "cargo run -vv --example server "
                + SOURCE_DIR
                + "/pfv-ivy/doc/examples/quic/index.html --keylog --stateless-retry --listen 127.0.0.1:4443",
                "quic-go": "./server -c "
                + SOURCE_DIR
                + "/pfv-ivy/doc/examples/quic/cert.pem -k "
                + SOURCE_DIR
                + "/pfv-ivy/doc/examples/quic/priv.key -r -p 4443 127.0.0.1",
