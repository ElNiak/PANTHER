"""
Storage Event Classes Module

This module defines all storage event classes used in the PANTHER framework's observer system.
"""

from datetime import datetime
from typing import Generic, Any, TypeVar

from panther.core.events import TestEvent
