                            ...
                            with open(prefix + splitted_line[0], "r") as f:
                                ...
                                if has_implem:
                                    ...
                                    for l in content[line:]:
                                        ...
                                        if (
                                            len(current_elem["implementation"]) > 0
                                            and current_elem["implementation"][-1][
                                                "line"
                                            ]
                                            < c_line
                                        ):  # Not sure it is always true
                                            current_elem["implementation"].append(
                                                {
                                                    "line": c_line,
                        ...
                        with open(prefix + splitted_line[0], "r") as f:
                            ...
                            if current_action and signature_type in [
                                ...
                                for l in content[line:]:
                                    ...
                                    if (
                                        len(current_action["monitor"][signature_type])
                                        > 0
                                        and current_action["monitor"][signature_type][
                                            -1
                                        ]["line"]
                                        < c_line
                                    ):
                        ...
                        with open(prefix + splitted_line[0], "r") as f:
                            ...
                            for l in content[line:]:
                                if "}" in l:
                                    ...
                                    if (
                                        len(current_elem["implementation"]) > 0
                                        and current_elem["implementation"][-1]["line"]
                                        < c_line
                                    ):  # Not sure it is always true
                                        current_elem["implementation"].append(
                                            {
