...
@click.group()
def tutorial():
    r"""Interactive tutorials and learning platform.
...
def run(
    ...
    r"""Run a specific tutorial with guided learning.
...
def list_tutorials(ctx, output_format: str, level: str, category: str):
    r"""List all available tutorials with filtering and detailed information.
...
def interactive(ctx, quick_start: bool):
    r"""Start interactive tutorial mode with guided selection.
