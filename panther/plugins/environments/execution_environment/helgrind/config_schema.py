...
class HelgrindConfig(ExecutionEnvironmentConfig):
    """
    Configuration for Helgrind command generation.
    """

    input_file: str | None = None  # Input file for Helgrind
    output_file: str | None = None  # Output file for Helgrind
    ...
    other_flags: list[str] = field(default_factory=list)  # Other Helgrind flags
