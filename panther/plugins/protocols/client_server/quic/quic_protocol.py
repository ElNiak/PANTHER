...
from panther.plugins.plugin_decorators import register_protocol
...
@register_protocol(
    ...
    versions=[
        ...
        "draft-29",     # IETF QUIC draft 29
        "draft-27",     # IETF QUIC draft 27
        "draft-27-vuln1",  # Draft 27 with vulnerability test 1
        "draft-27-vuln2",  # Draft 27 with vulnerability test 2
    ],
