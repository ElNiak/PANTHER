...
class MetricsObserverConfig(BaseObserverConfig):
    ...
    resource_collection_interval: int = 10  # Interval for resource collection in seconds
...
class ObserverConfig:
    ...
    experiment: ExperimentObserverConfig = field(default_factory=ExperimentObserverConfig)
