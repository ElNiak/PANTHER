...
function test(spec, input, callback, only, disabled, serial) {
  ...
  var testers = only ? _ava.default.only : _ava.default;
  testers = disabled ? testers.skip : testers;
  testers = serial ? testers.serial : testers;

  if (callback) {
    testers(spec + " (tree)", function (t) {
  ...
  testers(spec + " (toString)", function (t) {
