...
sudo apt install --yes python3.10.9
sudo apt install --yes python3.10.9-distutils
sudo apt install --yes python3.10.9-dev

python3.10.9 -m pip uninstall --yes setuptools
python3.10.9 -m pip uninstall --yes cryptography
python3.10.9 -m pip uninstall --yes cffi
python3.10.9 -m pip uninstall --yes setuptools-rust
python3.10.9 -m pip uninstall -e .

python3.10.9 -m pip install werkzeug==2.0.3
python3.10.9 -m pip install --upgrade pip
python3.10.9 -m pip install --upgrade distlib
python3.10.9 -m pip install --upgrade launchpadlib
python3.10.9 -m pip install --upgrade setuptools
