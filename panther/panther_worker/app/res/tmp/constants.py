...
QUIC_DIR = SOURCE_DIR + "/panther-ivy/protocol-testing/quic/"
RESULT_DIR = SOURCE_DIR + "/panther-ivy/protocol-testing/quic/test/"
IVY_DIR = SOURCE_DIR + "/panther-ivy"
ENV_VAR = {
    ...
    # "max_idle_timeout":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/max_idle_timeout.txt",
    # "max_ack_delay":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/max_ack_delay.txt",
    # "max_udp_payload_size":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/max_udp_payload_size.txt",
    # "max_datagram_frame_size":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/max_datagram_frame_size.txt",
    # "max_stream_data_bidi_local":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/max_stream_data_bidi_local.txt",
    # "max_stream_data_bidi_remote":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/max_stream_data_bidi_remote.txt",
    # "max_stream_data_uni":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/max_stream_data_uni.txt",
    "initial_max_stream_id_bidi": SOURCE_DIR
    + "/panther-ivy/protocol-testing/quic/initial_max_stream_id_bidi.txt",
    # "initial_max_stream_id_uni":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/initial_max_stream_id_uni.txt",
    # "max_data":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/max_data.txt",
    # "max_bidi_streams":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/max_bidi_streams.txt",
    # "max_uni_streams":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/max_uni_streams.txt",
    ...
    # "initial_max_bidi_streams":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/initial_max_bidi_streams.txt",
    # "initial_max_uni_streams":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/initial_max_uni_streams.txt",
    # "max_packet_size":  SOURCE_DIR + "/panther-ivy/protocol-testing/quic/max_packet_size.txt",
...
# cp lib/libz3.so submodules/z3/build/python/z3; export IVY_INCLUDE_PATH=IVY_INCLUDE_PATH:/usr/local/lib/python3.10/dist-packages/ms_ivy-1.8.25-py3.10-linux-x86_64.egg/ivy/include/1.7;export Z3_LIBRARY_DIRS=$PWD/submodules/z3/build; export Z3_LIBRARY_PATH=$PWD/submodules/z3/build; export PATH=$PATH:$PWD/submodules/z3/build; export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$PWD/submodules/z3/build; export PYTHONPATH=$PYTHONPATH:$PWD/submodules/z3/build/python; ivy ui=cti protocol-testing/client_server_example.ivy
# cp lib/libz3.so submodules/z3/build/python/z3; export IVY_INCLUDE_PATH=IVY_INCLUDE_PATH:/usr/local/lib/python3.10/dist-packages/ms_ivy-1.8.25-py3.10-linux-x86_64.egg/ivy/include/1.7;export Z3_LIBRARY_DIRS=$PWD/submodules/z3/build; export Z3_LIBRARY_PATH=$PWD/submodules/z3/build; export PATH=$PATH:$PWD/submodules/z3/build; export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$PWD/submodules/z3/build; export PYTHONPATH=$PYTHONPATH:$PWD/submodules/z3/build/python; cd protocol-testing/quic/quic_tests/server_tests; ivy ui=cti show_compiled=false pedantic=true isolate_mode=test isolate=this quic_server_test_stream.ivy; cd ../../../../..
...
TESTS_SERVER = {
    ...
    "0rtt_test": ["quic_server_test_0rtt"],
    "retry_test": ["quic_server_test_retry"],
    "vn_test": ["quic_server_test_version_negociation"],
    "attacks_test": [
...
TESTS_MIM = {"attacks_test": ["quic_mim_test_forward"]}
...
TESTS_CLIENT = {
    ...
    "retry_test": ["quic_client_test_retry"],
    "vn_test": ["quic_client_test_version_negociation"],
    "attacks_test": [
...
IMPLEMENTATIONS = {
    ...
    "picoquic-shadow": [
        [
            IMPLEM_DIR + "/picoquic",
            "./picoquicdemo -e implem -a ALPN -l - -D -L -q "
            + SOURCE_DIR
            + "/qlogs/picoquic",
        ],
        [
            IMPLEM_DIR + "/picoquic",
            "./picoquicdemo -n servername -e implem -a ALPN -T "
            + SOURCE_DIR
            + "/tickets/ticket.bin -v VERSION -l - -D -L  10.0.0.1 4443",
        ],
    ],
    # # Server:
    # # Client:
    ...
    # # Client:
    # "lsquic":[
    #     [IMPLEM_DIR + '/lsquic/bin/','./http_server -c www.example.org/,'+SOURCE_DIR +'/panther-ivy/protocol-testing/quic/leaf_cert.pem,'+SOURCE_DIR +'/panther-ivy/protocol-testing/quic/leaf_cert.key -Q ALPN -D -s 127.0.0.1:4443 -l event=debug,engine=debug -o version=VERSION -G '+SOURCE_DIR +'/tls-keys/'],
    ...
    # # Client:
    # "lsquic-vuln":[
    #     [IMPLEM_DIR + '/lsquic-vuln/bin/','./http_server -c www.example.org/,'+SOURCE_DIR +'/panther-ivy/protocol-testing/quic/leaf_cert.pem,'+SOURCE_DIR +'/panther-ivy/protocol-testing/quic/leaf_cert.key -Q ALPN -D -s 127.0.0.1:4443 -l event=debug,engine=debug -o version=VERSION -G '+SOURCE_DIR +'/tls-keys/'],
    ...
    # "quic-go":[
    #     [IMPLEM_DIR + '/quic-go/server/','./server -c '+SOURCE_DIR +'/panther-ivy/protocol-testing/quic/cert.pem -k '+SOURCE_DIR +'/panther-ivy/protocol-testing/quic/priv.key -p 4443 127.0.0.1'],
    ...
    #     [IMPLEM_DIR + '/quinn/','cargo run -vv --example server '+SOURCE_DIR +'/panther-ivy/protocol-testing/quic/index.html --listen 127.0.0.1:4443'],
    ...
    #     [IMPLEM_DIR + '/quiche/','cargo run --bin quiche-server --  --root . --no-grease --cert '+ SOURCE_DIR +'/panther-ivy/protocol-testing/quic/cert.pem --early-data --dump-packets '+SOURCE_DIR +'/qlogs/quiche/dump_packet.txt --key '+SOURCE_DIR +'/panther-ivy/protocol-testing/quic/priv.key --no-retry --listen 127.0.0.1:4443' ],
