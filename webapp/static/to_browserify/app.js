...
$.get(
  ...
  function (data) {
    ...
    if (typeof cytoscape("core", "cyqtip") === "undefined") {
    ...
    cy.on("mouseover", "node", function (e) {
      ...
      //console.log("mouseover qtip 2:" + this.id());
    });
    ...
    cy.on("mousedown", "node", function (e) {
      ...
      /*node.qtip({
        overwrite: false,
        content: function(){
          return '<u>Information :</u> </br>' + this.data('long_info') + '</br></br>  <u>Actions :</u> </br>' + this.data('actions') + '</br></br> <u>Events:</u> </br>' + this.data('events') + '</br>';
        },
        show: {
          event: "mouseover",
          ready: true
    ...
    cy.on("click", "node", function (e) {
      ...
      var node = e.target;
      //console.log("mouseover qtip:" + this.id());
      node.qtip({
          overwrite: false,
          content: function(){
            return '<u>Information :</u> </br>' + this.data('long_info') + '</br></br>  <u>Actions :</u> </br>' + this.data('actions') + '</br></br> <u>Events:</u> </br>' + this.data('events') + '</br>';
    ...
    cy.on("click", "edge", function (e) {
      ...
      edge.qtip({
        overwrite: false,
        content: function(){ // TODO add source/target info
          return '<u>Source Concept:  </u> </br>' + this.data('source_obj') + '</br></br> <u>Destination Concept:</u>   </br>' + this.data('target_obj') + '</br> </br> <u>Information :</u> </br>' + this.data('long_info') + '</br></br>  <u>Actions :</u> </br>' + this.data('actions') + '</br></br> <u>Events:</u> </br>' + this.data('events') + '</br>';
        },
        show: {
          event: "click",
          //ready: true
