...
class NeoIvy:
    ...
    def new_formal_model(protol:str):
        ...
        # experts_methodology = _parse_markdown_sections('/mnt/data/ExpertsMethodology.md')
        # new_project         = _parse_markdown_sections('/mnt/data/NewProject.md')
        ...
        instruction = inspect.cleandoc(
            ...
            6. Apply "{step_A}" to "{step_2}" for protocol {protol}
            7. Apply "{step_B}" to "{step_2}" for protocol {protol}
            8. Apply "{step_C}" to "{step_2}" for protocol {protol}
            9. Apply "{step_E}" to "{step_2}" for protocol {protol}
            10. Apply "{step_D}" to "{step_2}" for protocol {protol}
            
            11. Apply "{step_A}" to "{step_3}" for protocol {protol}
            12. Apply "{step_B}" to "{step_3}" for protocol {protol}
            13. Apply "{step_C}" to "{step_3}" for protocol {protol}
            14. Apply "{step_D}" to "{step_3}" for protocol {protol}
            15. Apply "{step_E}" to "{step_3}" for protocol {protol}
            
            16. Apply "{step_A}" to "{step_4}" for protocol {protol}
            17. Apply "{step_B}" to "{step_4}" for protocol {protol}
            18. Apply "{step_C}" to "{step_4}" for protocol {protol}
            19. Apply "{step_D}" to "{step_4}" for protocol {protol}
            20. Apply "{step_E}" to "{step_4}" for protocol {protol}
            
            21. Apply "{step_A}" to "{step_5}" for protocol {protol}
            22. Apply "{step_B}" to "{step_5}" for protocol {protol}
            23. Apply "{step_C}" to "{step_5}" for protocol {protol}
            24. Apply "{step_D}" to "{step_5}" for protocol {protol}
            25. Apply "{step_E}" to "{step_5}" for protocol {protol}
            '''
        )
        print(instruction)
        return instruction
