...
More recent and concrete application of NCT to the QUIC protocol. Read and learn it.
...
The RFCs are defined at https://www.rfc-editor.org/rfc-index.html and rfc-all.txt
