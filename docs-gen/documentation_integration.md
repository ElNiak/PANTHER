...
|------|---------|----------|
| `add_cross_references.py` | Adds "See Also" sections to connect related docs | `docs-gen/` |
| `verify_links.py` | Validates and auto-fixes links in Markdown files | `docs-gen/` |
| `update_mkdocs_nav.py` | Updates MkDocs navigation structure | `docs-gen/` |
| `enhance_mkdocs_config.py` | Adds link checking plugins to MkDocs config | `docs-gen/` |
| `gen_ref_pages.py` | Generates API reference docs from docstrings | `docs-gen/mkdocs/` |
| `generate_plugin_docs.py` | Generates plugin documentation | `docs-gen/mkdocs/` |
| `pre_commit_docs.py` | Pre-commit hook for documentation checks | `docs-gen/` |
| `update_docs.sh` | Script to run all documentation tasks | `docs-gen/` |
...
1. Run `python docs-gen/verify_links.py --autofix` to automatically fix them
...
1. Run `python docs-gen/add_cross_references.py` to add cross-references
...
1. Run `python docs-gen/update_mkdocs_nav.py` to update the navigation
