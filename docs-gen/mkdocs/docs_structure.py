...
def organize_docs():
    ...
    index_template = repo_dir / "docs-gen" / "mkdocs" / "index_template.md"
    ...
    structure = {
        ...
        "developer_guide": [
            {"source": "CONTRIBUTING.md", "dest": "docs/developer_guide/contributing.md"},
            {"source": "docs-gen/README.md", "dest": "docs/developer_guide/documentation.md"},
            {"source": "docs-gen/documentation_workflow.md", "dest": "docs/developer_guide/documentation_workflow.md"},
            {"source": "docs-gen/style_guide.md", "dest": "docs/developer_guide/style_guide.md"},
            {"source": "docs-gen/documentation_integration.md", "dest": "docs/developer_guide/documentation_integration.md"},
            {"source": "docs-gen/documentation_links.md", "dest": "docs/developer_guide/documentation_links.md"},
            {"source": "docs-gen/documentation_enhancements.md", "dest": "docs/developer_guide/documentation_enhancements.md"},
            {"source": "panther/plugins/development.md", "dest": "docs/developer_guide/plugin_development.md"},
            # Plugin development guides
            {"source": "panther/plugins/services/development.md", "dest": "docs/developer_guide/services_development.md"},
            {"source": "panther/plugins/services/iut/development.md", "dest": "docs/developer_guide/iut_development.md", "optional": True},
            {"source": "panther/plugins/services/testers/development.md", "dest": "docs/developer_guide/testers_development.md"},
            {"source": "panther/plugins/environments/execution_environment/development.md", "dest": "docs/developer_guide/execution_environment_development.md"},
            {"source": "panther/plugins/environments/network_environment/development.md", "dest": "docs/developer_guide/network_environment_development.md"},
            {"source": "panther/plugins/protocols/development.md", "dest": "docs/developer_guide/protocols_development.md"},
        ],
        "reference": [
            {"source": "PACKAGING.md", "dest": "docs/reference/packaging.md"},
            {"source": "panther/plugins/plugin_template.md", "dest": "docs/reference/plugin_template.md"},
            {"source": "tests/README.md", "dest": "docs/reference/testing.md", "optional": True},
        ],
        "project": [
            {"source": "CHANGELOG.md", "dest": "docs/project/changelog.md"},
            {"source": "LICENSE.md", "dest": "docs/project/license.md", "optional": True},
        ]
    }
    ...
    for plugin_dir in plugin_dirs:
        ...
        for path in Path(repo_dir / plugin_dir).glob("**/*.md"):
            ...
            if path.name == "README.md" or path.name.endswith('.md'):
                ...
                dest_path = docs_dir / dest_category / path.relative_to(repo_dir / plugin_dir.split('/')[0] / plugin_dir.split('/')[1])
