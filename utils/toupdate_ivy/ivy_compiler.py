...
#            print "checking: {} = {}".format(name,action)
        ...
        for isol in im.module.isolates.values():
            isol.args += tuple(global_objects)
            isol.with_args += len(global_objects)
        ...
        #print mod.call_graph()
        if create_isolate and hasattr(iso, 'create_isolate'):
