...
IMPLEMENTATIONS = {
    ...
    "quant":[ # NOT available in RFC9000 06/06/22
        ...
        [QUIC_DIR, IMPLEM_DIR + '/quant/Debug/bin/client -e 0xff00001d -i n1.0 -c false -r 10 -s '+SOURCE_DIR +'/tickets/ticket.bin -l '+SOURCE_DIR +'/tls-keys/secret.log -q '+SOURCE_DIR +'/qlogs/quant -t 3600 -v 5  https://10.0.1.1:4443/index.html']
    ],
    ...
    "quant-vuln":[
        ...
        [QUIC_DIR, IMPLEM_DIR + '/quant/Debug/bin/client -e 0xff00001c -c false -r 10 -l '+SOURCE_DIR +'/tls-keys/secret.log -q '+SOURCE_DIR +'/qlogs/quant-vuln -t 3600 -v 5  https://10.0.1.1:4443/index.html']
    ],
    # Server:
    # Client:
    "picoquic":[
        [IMPLEM_DIR + '/picoquic','./picoquicdemo -e n1.0 -a hq-29 -l - -D -L -q '+SOURCE_DIR +'/qlogs/picoquic'],
        [IMPLEM_DIR + '/picoquic','./picoquicdemo -n servername -e n1.0 -a hq-29 -T '+SOURCE_DIR +'/tickets/ticket.bin -v ff00001d -l - -D -L  10.0.1.1 4443']
    ],
    ...
    "mvfst":[
        [IMPLEM_DIR + '/mvfst/_build/build/quic/samples/','./echo -mode=server -host=10.0.2.1 -port=4443  -v=10  '],
        [IMPLEM_DIR + '/mvfst/_build/build/quic/samples/','./echo -mode=client -host="10.0.1.1" -port=4443  -v=10 -stop_logging_if_full_disk']
    ],
    ...
    "lsquic":[
        ...
        [IMPLEM_DIR + '/lsquic/bin/','./http_client -0 '+SOURCE_DIR +'/tickets/ticket.bin -4 -Q hq-interop -R 10 -w 7 -r 7 -s 10.0.1.1:4443 -t -l event=debug,engine=debug -p /1.html /2.html /3.html /4.html /5.html /6.html /7.html -H 127.0.0.1 -o version=00000001 -o scid_len=8']
    ],
    # Server: Internal error
    # Client:
    "lsquic-vuln":[
    ...
    "aioquic":[
        ...
        [IMPLEM_DIR + '/aioquic/','python3.9 examples/http3_client.py --zero-rtt -s '+SOURCE_DIR +'/tickets/ticket.bin -l '+SOURCE_DIR +'/tls-keys/secret.log -v -q '+SOURCE_DIR +'/qlogs/aioquic/ --ca-certs tests/pycacert.pem -i --insecure --legacy-http https://10.0.1.1:4443/index.html https://10.0.1.1:4443/index.html https://10.0.1.1:4443/index.html https://10.0.1.1:4443/index.html https://10.0.1.1:4443/index.html https://10.0.1.1:4443/index.html https://10.0.1.1:4443/index.html https://10.0.1.1:4443/index.html https://10.0.1.1:4443/index.html']
    ],
    ...
    "quinn":[ # TODO RUST_LOG="debug" RUST_BACKTRACE=1  server
        ...
        [IMPLEM_DIR + '/quinn/','cargo run -vv --example client https://10.0.1.1:4443/index.html --keylog']
    ],
    ...
    "quiche":[ # TODO RUST_LOG="debug" RUST_BACKTRACE=1 
        ...
        [IMPLEM_DIR + '/quiche/','cargo run --bin quiche-client -- https://10.0.1.1:4443/index.html --dump-json --session-file '+SOURCE_DIR +'/tickets/ticket.bin --wire-version 00000001 --no-verify --body / -n 5']
    ],
    # Server:
    # Client:
    # "chromium":[
