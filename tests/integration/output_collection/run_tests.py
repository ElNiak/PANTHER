...
Examples:
  ...
  %(prog)s --debug                  # Run with debug output
    ...
    parser.add_argument(
        "--all", action="store_true", help="Run all output collection tests"
    )
    parser.add_argument(
        "--docker-compose",
        action="store_true",
    ...
    parser.add_argument(
        "--shadow-ns", action="store_true", help="Run Shadow NS environment tests"
    )
    ...
    parser.add_argument(
        "--unit", action="store_true", help="Run unit tests only (no Docker required)"
    )
    parser.add_argument(
        "--quick", action="store_true", help="Run quick tests only (unit + edge cases)"
    )
    ...
    parser.add_argument(
        "--no-capture", action="store_true", help="Don't capture test output"
    )
    parser.add_argument(
        "--keep-containers",
        action="store_true",
