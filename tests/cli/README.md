...
```bash
# Run all tests
python tests/cli/run_tests.py

# Run with coverage
python tests/cli/run_tests.py --coverage --html-coverage

# Run specific test category
python tests/cli/run_tests.py --unit
python tests/cli/run_tests.py --integration
```

### Advanced Usage
```bash
# Run specific command tests
python tests/cli/run_tests.py --config
python tests/cli/run_tests.py --plugins

# Run with parallel execution
python tests/cli/run_tests.py --parallel 4

# Run specific test file
python tests/cli/run_tests.py --test-file tests/cli/unit/commands/test_config.py

# Run tests matching pattern
python tests/cli/run_tests.py --test-pattern "test_config_validate"

# Skip slow tests
python tests/cli/run_tests.py --fast

# Debug mode
python tests/cli/run_tests.py --debug --verbose
```
...
# With coverage
pytest tests/cli/ --cov=panther.cli --cov-report=html

# Specific tests
pytest tests/cli/unit/commands/test_config.py::TestConfigValidateCommand::test_validate_valid_config

# With markers
pytest tests/cli/ -m "config and not slow"
```
...
pytest tests/cli/unit/commands/test_config.py::test_specific -s -vv

# Run with pdb debugging
pytest tests/cli/unit/commands/test_config.py::test_specific --pdb

# Run with full traceback
pytest tests/cli/ --tb=long
```
...
- name: Run CLI Tests
  run: |
    python tests/cli/run_tests.py --coverage --junit-xml=test-results.xml
...
repos:
  - repo: local
    hooks:
      - id: cli-tests
        name: CLI Tests
        entry: python tests/cli/run_tests.py --fast
        language: system
...
python tests/cli/run_tests.py -k "performance"

# Monitor test timing
python tests/cli/run_tests.py --durations=10
```
