...
class TestPantherIvyCommands(unittest.TestCase):
    ...
    @patch('panther.plugins.services.testers.panther_ivy.panther_ivy.PantherIvyServiceManager._load_service_config')
    @patch('panther.plugins.services.testers.panther_ivy.panther_ivy.PantherIvyServiceManager._load_tests')
    def test_add_command_flag_validation(self, mock_load_tests, mock_load_config):
        ...
        with self.assertRaises(TypeError):
            manager.add_command(
                phase="compile",
                command="echo hi",
                is_function_definition="yes"  # Wrong type
            )
