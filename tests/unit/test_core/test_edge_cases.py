...
def run_test():
    ...
    service_config_to_test = type("ServiceConfig", (), {
        "implementation": type("Implementation", (), {
            "use_system_models": True  # Mock implementation
        })
        ...
        ,
        {
            ...
            "input": [
                ...
                (
                    ...
                    else "rm -rf /opt/panther_ivy/protocol-testing/{}/build/*;".format(protocol.name)
                ),
            ]
        }
    ]
