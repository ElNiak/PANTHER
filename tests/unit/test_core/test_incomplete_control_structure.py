...
import unittest
from panther.utils.command import ShellCommand, format_multiline_command
...
class TestIncompleteControlStructures(unittest.TestCase):
    ...
    def test_incomplete_while_loop_ending_with_do(self):
        ...
        self.assertIn('done', shell_cmd.command, "Command should contain 'done', indicating it was auto-completed")
        ...
        self.assertGreater(done_line, do_line + 1, "Should have at least one line between 'do' and 'done'")
    ...
    def test_format_multiline_command_autocompletes_while_loop(self):
        ...
        self.assertIn('Waiting for file', formatted, "Should include waiting for file message in the body")
