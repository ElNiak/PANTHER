...
TEMPLATE_PATH = Path('/Users/elniak/Documents/Project/PANTHER/panther/plugins/environments/network_environment/docker_compose/templates/entrypoint.sh.jinja')
...
def render_commands():
    ...
    test_commands = {
        "pre_run_cmds": [
            ...
            create_test_command("control_structure", "while [ ! -f /app/sync_logs/ivy_ready.log ]; do sleep 1; done"),
    ...
    try:
        rendered = template.render(
            structured_commands=test_commands,
