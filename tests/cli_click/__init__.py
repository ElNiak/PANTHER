...
Usage:
    ...
    # Run unit tests only
    pytest tests/cli_click/unit/

    # Run integration tests only
    pytest tests/cli_click/integration/

    # Run specific command tests
    pytest tests/cli_click/unit/commands/test_config.py

    # Run with coverage
    pytest tests/cli_click/ --cov=panther.cli_click

    # Run with markers
    pytest tests/cli_click/ -m "not slow"
    pytest tests/cli_click/ -m "config"
"""
