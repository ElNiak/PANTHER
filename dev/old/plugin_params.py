...
def find_plugin(plugin_name: str) -> tuple[str, str | None]:
    """
...
def list_plugin_parameters(
    plugin_name: str, plugin_type: str | None = None, protocol: str | None = None
) -> dict[str, Any]:
    """
    ...
    try:
        ...
        if plugin_type in ["iut", "tester"] and not protocol:
            ...
            print(
                f"Example: panther --list-plugin-params {plugin_name} --plugin-type {plugin_type} --protocol quic"
            )
